...
download.file("https://dl.dropboxusercontent.com/u/7710864/data/gaData.rda",destfile="gaData.rda",method="wininet")
load("gaData.rda")
...
summary(glm2)
exp(coef(glm2))
# adding log10 to offset 
glm2a <- glm(gaData$simplystats ~ julian(gaData$date),offset=log(visits+10),
            family="poisson",data=gaData)
summary(glm2a)
exp(coef(glm2a))
